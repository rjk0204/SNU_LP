...
@torch.no_grad()
def detect(weights=str(ROOT / '/data3/jaekyung0204/SNU_LP/weights/detection.pt'),
        source=str(ROOT / '/data3/jaekyung0204/SNU_LP/dataset/video/test1.mp4'), 
        data=str(ROOT / '/data3/jaekyung0204/SNU_LP/detection/data/kamo_lp.yaml'),  
        ...
        project=str(ROOT / 'inference_result/track'),  name='exp',  
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / '/data3/jaekyung0204/SNU_LP/weights/detection.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=ROOT / '/data3/jaekyung0204/SNU_LP/dataset/video/test1.mp4', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--data', type=str, default=ROOT / '/data3/jaekyung0204/SNU_LP/detection/data/kamo_lp.yaml', help='(optional) dataset.yaml path')
    ...
    parser.add_argument('--project', default=ROOT / 'inference_result/track', help='save results to project/name')
    parser.add_argument('--name', default='exp', help='save results to project/name')
    parser.add_argument('--exist-ok', action='store_true', help='existing project/name ok, do not increment')
    parser.add_argument('--line-thickness', default=50, type=int, help='bounding box thickness (pixels)')
